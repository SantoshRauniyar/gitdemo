...
class doctor_registers extends Template
{
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/doctor_filter',
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://care.haspatal.com/api/doctor_details_to_kizaku',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
curl_close($curl);
                    ...
                    $data['data']=$res->data;
                    $data['lang']=$res->lang;
                    return $this->view('doctors/show',$data);
                    }
                            /* if($res->status)
                             {
                                // echo $res->status;
...
if($data->status)
{
    ...
    return redirect('doctor_registers/view_doctor/'.$id);
}
else
{
    return redirect('doctor_registers/view_doctor/'.$id);
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/totaldoctors',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
//echo $response;
                                            ...
                                            if(!empty($response))
                                            {
                                                ...
                                                $drdata['fortnight']=$data->fortnight;
                                                 ...
                                                 $drdata['heading']='Approved';
                                                 $drdata['link']='0';
                                                return $this->view('doctors/dr_dashboard',compact('drdata'));
                                            }
                                            else
                                            {
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/totalPendingdoctors',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/totalRejectedDoctors',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/totaldoctors',//totalregDoctors
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
//echo $response;
	                             ...
	                             ****/
	                            public function doctor_list($filterby=null,$status=null)
	                            {
        $url='';
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'http://13.59.46.134/api/doctorListToKizaku'.$url.'',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 0,
...
$data=json_decode($response);
                    if(!empty($response))
                    {
                        ...
                        $heading=$url;
                        return $this->view('doctors/dlist',compact('responseData','heading'));
                    }
