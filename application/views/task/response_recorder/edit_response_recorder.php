			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					?>	<h3><b>Response Recorder Task</b></h3>
											<form role="form" name="editprofileform" id="editprofileform" method="post" action="<?= base_url('task/do_update_recorder').'/'.$responselist->rec_id?>" enctype="multipart/form-data">
                    ...
                    ?>
                      <option value="<?=$value->id ?>" <?= $responselist->avenue_name==$value->id?"selected":"" ?>><?=$value->avenue_name ?></option>
                    <?php
                      }
                      ?>
                          </select>
                          <span class="text-danger"><?= form_error('avenue_name') ?></span>
								...
								<div class="form-group">
                					...
                					<label for="dtp_input3" class="control-label">Post  Title<strong><font color='red'>*</font></strong></label>
                						...
                						<input type="text" value="<?=$responselist->title ?>" class="form-control" name="title">
                    ...
                    ?>
                      <option value="<?=$value->id ?>" <?= $responselist->res_type==$value->id?"selected":"" ?>><?=$value->type_name ?></option>
                    <?php
                      }
                      ?>
                                  </select>
                                  ...
                                  <label>Response <strong><font color='red'>*</font></strong></label>
           												<input type="text" value="<?=$responselist->response ?>" class="form-control" name="response">           												
                                ...
                                <div class="row">
                                  ...
                                  <label>Response Date</label>
           												<input type="date" value="<?= $responselist->rdate ?>" name="rdate" class="form-control">
           												<span class="text-danger"><?= form_error('rdate')?></span>
           											</div>
                                  <div class="col-md-3">
                                  <label>Response Time</label>
                                  <input type="time" name="rtime" value="<?= $responselist->rtime ?>" class="form-control">
                            ...
                            <select class="form-control" name="suggested_reply">
                              <?php
                                  ...
                                  foreach ($replies as $value) {
                                    ?>
                                          <option value="<?= $value->id ?>" <?= $responselist->suggested_reply==$value->id?"selected":"" ?>><?= $value->replies ?></option>
                              ...
                              ?>
                					...
                					<input type="url" name="post_url" value="<?= $responselist->post_url ?>" class=" form-control">
                          ...
                          <input type="url" name="responder_url" <?= $responselist->responder_url ?> class=" form-control">
                    ...
                    <div class="form-group">
                       ...
                       <textarea class="form-control" rows="5" name="given_reply"><?= $responselist->given_reply?></textarea>
              ...
              <h4 style="color:#ef0f0f"><b>Assign</b></h4>
                  <hr>
         				<div class="form-group">
									...
									<input type="text" class="form-control" value="<?= $responselist->reply_by?>" name="reply_by">
									...
									<input type="datetime-local" class="form-control" value="<?= $responselist->reply_time?>" name="reply_time">
									<span class="text-danger"><?= form_error('reply_time') ?></span>
								</div>
								...
								<select class="	form-control dept" id="dept" name="dept" title="select Department">
										...
										?>
											<option value="<?=$value->did ?>" <?= $responselist->department==$value->did?"selected":""?>><?=$value->dtitle ?></option>
