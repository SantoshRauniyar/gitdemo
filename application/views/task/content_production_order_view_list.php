												...
												?>
													...
													<tr>
														...
														<td>
															...
															<a href="<?=  base_url('task/production_view').'/'.$value->poid.'/'.$value->created_by ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">View</a>
