												...
												?>
													...
													<tr>
														...
														<td>
																		...
																		<?php   if($value->assign_to==$this->session->userdata('id')) { ?>
															<a href="<?=  base_url('task/opentask').'/'.$value->poid.'/'.'2' ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">Open Task</a>
															<?php } 

																		else if($value->created_by==$this->session->userdata('id'))
																								{
															 ?>

															 							<a href="<?=  base_url('task/production_view').'/'.$value->poid ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">View Details</a>
															 						<?php } ?>
