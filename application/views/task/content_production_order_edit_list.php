												...
												?>
													...
													<tr>
														...
														<td>
															...
															<a href="<?=  base_url('task/production_edit').'/'.$value->poid.'/'.$value->created_by ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">Edit</a>
