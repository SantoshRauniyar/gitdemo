...
<div style="padding:2%;">
	...
	<th>Target Completion</th><th>Task Title</th><th>Created By</th><th>Created On</th><th>Priority</th><th>Program</th><th>Project</th><th>Assigned to</th><th>Status</th><th>Action</th>
				 ...
				 if($this->session->userdata('id')==$value->created_by){?>
<td><a href="<?=  base_url('task/single_edit_task').'/'.$value->id ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">Edit Task</a></td>
<?php
				}
						else
						{
														...
														?>
<td><a  href="<?=  base_url('task/open_task').'/'.$value->id.'/2' ?>" style="color:white;background-color:#ef0f0f;border-color: #ef0f0f" class="	btn btn-info">Open Task</a></td>
													<?php } ?>
													</tr>
