		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				...
				<div class="panel-body">
					...
					<form role="form" name="editprofileform" id="editprofileform" method="post" action="<?= base_url('task/do_save_lead_qualified')?>" enctype="multipart/form-data">
          ...
          <option value="<?= $value->lead_name."#".$value->phone."#".$value->lead_email."#".$value->lead_code ?>"><?= $value->lead_name."-".$value->phone." ".$value->lead_email ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="action_on_lead" id="action_on_lead">
                        <option value="1">Select & Move to Qualification</option>
                        <option value="2">Reject Already Registered</option>
                        <option value="3">Edit Form and Qualify</option>
                        <option value="4">Reject and Blacklist</option>
                        <option value="5">Hold the Laed Info not available clearly</option>
                      </select>
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" rows="5" name="team_comment"></textarea>
                      <span class=" text-danger"><?= form_error('team_comment') ?></span>
                    </div>

                    <div class="form-group">
                      <label>Lead ID</label>
                      <input type="text" name="qlead_id" class="form-control" readonly="" id="lead_id">
