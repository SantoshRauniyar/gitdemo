      ...
      <div class="panel panel-default">
        ...
        <div class="panel-body">
          <div class="row">
            ...
            ?>
            <h3><b>View Lead Qualification</b></h3><br><br>
          <form role="form" name="editprofileform" id="editprofileform"  enctype="multipart/form-data">
                
                    <div class="form-group">
                            <select disabled="" class="form-control" name="checklead" id="checklead">
          ...
          <option value="<?= $value->lead_name."#".$value->phone."#".$value->lead_email."#".$value->lead_code ?>"><?= $value->lead_name."-".$value->phone." ".$value->lead_email ?></option>
                    ...
                    <div class="form-group">
                      ...
                      <select disabled="" class="form-control" name="action_on_lead" id="action_on_lead">
                    ...
                    <div class="form-group">
                      ...
                      <select disabled="" class="form-control" name="assign_for">
                        <?php
                    ...
                    <div class="form-group">
                      ...
                      <textarea disabled="" class="form-control" rows="5" name="team_comment"><?= $qlead->team_comment ?></textarea>
                      <span class=" text-danger"><?= form_error('team_comment') ?></span>
                    </div>

                    <div class="form-group">
                      <label>Lead ID</label>
                      <input readonly=""type="text" name="qlead_id" value="<?= $qlead->qlead_id ?>" class="form-control" readonly="" id="lead_id">
