...
<?php  
                             ...
                             var  formData={
                              ...
                              console.log(formData);
                               ...
                               $.ajax({
                                    ...
                                    url:'<?= base_url() ?>doctor_registers/countDoctors',
                                    dataType:'json',
                                    method:'post',
                                    data:formData,
   ...
   <section  id="task_board">
        <div class="container">
            <div class="col-12 titl_card">
                <h3 style="color:white;" >Doctor  <?= $drdata['heading']?>  Dashboard</h3>
            </div>
 ...
 <div class="pull-right" style="padding:10px;"><button type="button" class="btn btn-primary" style="background-color:#f10a0a;border-color:#f10a0a;"  data-toggle="modal" data-target=".bd-example-modal-lg">Change</button>
                ...
                <div class="col-md-12 col-lg-8 third_innr_crcl" style="float:all;">
                    <div class="row" style="justify-content: space-between;">
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                                 ...
                                 <a href="<?= base_url('doctor_registers/doctor_list/yesterdaylist/'.$drdata['link']) ?>"><span><b>Yesterday</b></span></a>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                             <a href="<?= base_url('doctor_registers/doctor_list/todaylist/'.$drdata['link']) ?>"><span><b>Today</b></span></a>
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                             <a href="<?= base_url('doctor_registers/doctor_list/weeklist/'.$drdata['link']) ?>"><span><b>This Week</b></span></a>
                    ...
                    <div class="row" style="justify-content: space-between;">
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                                 ...
                                 <a href="<?= base_url('doctor_registers/doctor_list/fortnightlist/'.$drdata['link']) ?>"><span><b>This Fortnight</b></span></a>
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                             <a href="<?= base_url('doctor_registers/doctor_list/monthlist/'.$drdata['link']) ?>"><span><b>This Month</b></span></a>
                        ...
                        <div class="col-sm-1"></div>
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                             <a href="<?= base_url('doctor_registers/doctor_list/yearlist/'.$drdata['link']) ?>"><span><b>This Year</b></span></a>
            ...
            <br>
                                ...
                                <h4><a href="javascript:void()" class="btn btn info blu" style="color:white;background-color:#f10a0a;border-color:#f10a0a;text-decoration:none;"  onclick="location.reload()">Refresh</a></h4>
                            </div>
                        <div class="col-sm-12 col-md-3 col-lg-3">
                              <?php if(empty($status)){  if(empty($today)){ ?><a class="btn btn info blu" style="color:white;background-color:#f10a0a;border-color:#f10a0a;" href="<?= base_url('dashboard/view_haspatal_dashboard/today') ?>">Today's Data</a><?php } else{ ?><a class="btn btn info blu" href="<?= base_url('dashboard/view_haspatal_dashboard') ?>">Total Data</a><?php }
                              }
                              ?>
                              
                              
                              
                              <?php if(!empty($status)){  if(empty($today)){ ?><a class="btn btn info blu" style=" color:white;background-color:#f10a0a;border-color:#f10a0a;" href="<?= base_url('dashboard/view_haspatal_dashboard/all') ?>">Total Data</a><?php } else{ ?><a class="btn btn info blu" href="<?= base_url('dashboard/view_haspatal_dashboard') ?>">Today's Data</a><?php }
                              }
                              ?>
                            </div>
                            <?php  if($this->session->userdata('user_role')!=19){ ?>
                         <div class="col-sm-12 col-md-3 col-lg-3">
                               <button type="button" class="btn btn-primary" data-toggle="modal" style=" color:white;background-color:#f10a0a;border-color:#f10a0a;" data-target=".bd-compare-modal-lg">Compare</button>
                            </div><?php } ?>
                            
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <a class="btn btn info blu" href="#" style=" color:white;background-color:#f10a0a;border-color:#f10a0a;">Chart</a>
                            </div>
