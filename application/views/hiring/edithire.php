				...
				<div class="panel-body" >
					<div class="row">
						...
						?>
							...
							<form role="form" name="editgroupform" id="editgroupform" method="post" action="<?= base_url('/Hiring/do_update')?>" enctype="multipart/form-data">
                            	                    	
                                                            <div class="form-group">
                                                                <label>Job Title  <span style="color:red;">*</span></label>
                                                                <input required="" value="<?= $data->job_title ?>" type="text" class="form-control" name="job_title">
                    ...
                    <?php echo form_error('job_time', '<div class="text-danger">', '</div>'); ?>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <input required=""  value="<?= $data->int_date ?>" type="datetime-local" class="form-control" name="int_date">
                                                                <?php echo form_error('int_date', '<div class="text-danger">', '</div>'); ?>

                                                            </div>
                                                  <div class="col-md-4">
                                                                <label>Interview Person <span style="color:red;">*</span></label>
                                                                <input value="<?= $data->int_person ?>"  required="" type="text" class="form-control" name="int_person">
                                                             ...
                                                             <div class="col-md-4">
                                                                ...
                                                                <input required="" value="<?= $data->int_location ?>" type="text" class="form-control" name="int_location">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <input required=""  value="<?= $data->deadline ?>" type="datetime-local" class="form-control" name="deadline">
                                                                <?php echo form_error('deadline', '<div class="text-danger">', '</div>'); ?>

                                                            </div>
                                                      <div class="col-md-6">
                                                                <label>Email <span style="color:red;">*</span></label>
                                                                <input required="" value="<?= $data->email ?>"  type="email" class="form-control" name="email">
                                                            ...
                                                            <div class="row">
                                                               <label>Salary & Benefits</label> 
                                                                ...
                                                                <div class="col-md-6" >
                                                                    <label> Range</label>
                                                                    <input required="" value="<?= $data->s_min ?>" type="number" class="form-control" name="s_min" placeholder="Min value"> 
                                                                    <?php echo form_error('s_min', '<div class="text-danger">', '</div>'); ?>

                                                                </div>
                                                                <div class="col-md-6" >
                                                                    <input required="" value="<?= $data->s_max ?>"  type="number" name="s_max"  class="form-control" placeholder="Max value"> 
                                                            ...
                                                            <div class="col-md-6">
                                                             ...
                                                             <div class="form-group">
                                                                ...
                                                                <textarea required=""  class="form-control" name="job_desc" cols="10" rows="5"><?= $data->job_desc ?></textarea>
								 ...
								 <br><br><br>
										<div class="form-group">
											<input required="" type="submit" value="Update"  name="submit" class="btn btn-info" style="color:white;background-color: #ef0f0f;border-color: #ef0f0f">
										</div>
