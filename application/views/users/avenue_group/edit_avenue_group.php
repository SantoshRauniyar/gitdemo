...
<div style="padding: 2%">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<input type="text" class="form-control" name="group_name" value="<?= $avenuedata->group_name ?>" >
								...
								<div class="form-group">
									<label>Remarks</label>
									<textarea class="form-control" rows="5" name="remarks"><?= $avenuedata->remarks ?></textarea>
...
<input type="submit" name="submit"  value="Update Group" class="btn btn-info " style="color:white;background-color: #ef0f0f;border-color: #ef0f0f" >
