				...
				<div class="panel-body">
					<div class="row">
						...
						?>
							...
							<form role="form" name="editprofileform" id="editprofileform" method="post" action="<?= base_url('StatePartner/do_update') ?>" enctype="multipart/form-data">
					
					<input type="hidden" name="pid" value="<?= $data['partner']->id ?>">
                                                    <?php
                    ...
                    switch($this->session->userdata('user_role'))
                    {
                        ...
                        foreach($data['countrylist'] as $row)
                            ...
                            ?>
                                    ...
                                    <option value='<?= $row->id ?>' <?php if(!empty($data['partner']->id)){ echo $d=$data['partner']->country_id==$row->id?'selected':''; } ?>><?= $row->country ?></option>
                        ...
                        <?php
                            break;
                                ...
                                foreach($data['statelist'] as $row)
                                {
                                    ?>
                                    
                                    <option value="<?= $row->id ?>" <?php if(!empty($data['partner']->id)){ echo $d=$row->id==$data['partner']->state_id?'selected':''; } ?>><?= $row->state ?></option>
                        ...
                        <?php
                            ...
                            break;
                                                    case 22:
                            ?>
                                <label>Select Field/City</label>
                                            <select class="form-control" name="city">
                                <?php
                                
                                foreach($data['citylist'] as $row)
                                {
                                    ?>
                                    
                                    <option value='<?= $row->id ?>' <?php if(!empty($data['partner']->id)){ echo $d=$row->id==$data['partner']->city_id?'selected':''; } ?>><?= $row->city ?></option>
                        ...
                        <?php
                            break;
								...
								<div class="form-group">
									...
									<input id="business_name" value="<?= $data['partner']->business_name ?>" name="business_name" class="form-control"  >
								</div>
								<div class="form-group">
									<label>Address:</label>
									<textarea id="address" name="address" class="form-control" ><?=$data['partner']->address ?></textarea>
								</div>
								...
								<div class="form-group">
									...
									<input id="contact_person_name" name="contact_person_name" value="<?= $data['partner']->contact_person?>" class="form-control" >
								</div>
								<!--	<div class="form-group">
                               	<label>Gender:</label>
								...
								<div class="form-group">
									...
									<input id="phone" name="phone" value="<?= $data['partner']->phone?>" class="form-control" >
								</div>
								<!--
								<div class="form-group">
