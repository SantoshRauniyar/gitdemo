				...
				<div class="panel-body">
					<div class="row">
						...
						?>
							...
							<form role="form" name="editprofileform" id="editprofileform" method="post" action="<?= base_url('Partner/do_update') ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        foreach($data['currencylist'] as $row)
                            ...
                            ?>
                                    ...
                                    <option value='<?= $row->id ?>' <?php if(!empty($data['partner']->id)){ echo $d=$data['partner']->currency==$row->id?'selected':''; } ?>><?= $row->cname ?></option>
