                             ...
                             var  formData={
                              ...
                              console.log(formData);
                               ...
                               $.ajax({
                                    ...
                                    url:'<?= base_url() ?>patient_registers/countPatients',
                                    dataType:'json',
                                    method:'post',
                                    data:formData,
   ...
   <section  id="task_board">
        <div class="container">
            <div class="col-12 titl_card">
                <h3 style="color:white;">Patients  <?= $ptdata['heading']?>   Dashboard</h3>
            </div>
 ...
 <div class="pull-right"><button type="button" class="btn btn-primary" data-toggle="modal" data-target=".bd-example-modal-lg">Change</button>
                ...
                <div class="col-md-12 col-lg-8 third_innr_crcl" style="float:all;">
                    <div class="row" style="justify-content: space-between;">
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                           ...
                           <h2  id="yesterday"><?= (int)$ptdata['yesterday'] ?></h2>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                            ...
                            <h2  id="today"><?= (int)$ptdata['today'] ?></h2>
                    ...
                    <div class="row" style="justify-content: space-between;">
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                           ...
                           <h2 id="fortnight"><?= (int)$ptdata['fortnight'] ?></h2>
                        ...
                        <div class="col-md-3 col-lg-3 col-sm-6 cmn_cls org marg_btm_cls">
                            ...
                            <h2 id="month"><?= (int)$ptdata['month'] ?></h2>
            ...
            <br>
                        ...
                        <div class="col-sm-12 col-md-3 col-lg-3">
                              <?php if(empty($status)){  if(empty($today)){ ?><a class="btn btn info blu bgc" href="<?= base_url('dashboard/view_haspatal_dashboard/today') ?>">Today's Data</a><?php } else{ ?><a class="btn btn info blu" href="<?= base_url('dashboard/view_haspatal_dashboard') ?>">Total Data</a><?php }
                              }
                              ?>
                              
                              
                              
                              <?php if(!empty($status)){  if(empty($today)){ ?><a class="btn btn info blu bgc" href="<?= base_url('dashboard/view_haspatal_dashboard/all') ?>">Total Data</a><?php } else{ ?><a class="btn btn info blu" href="<?= base_url('dashboard/view_haspatal_dashboard') ?>">Today's Data</a><?php }
                              }
                              ?>
                            </div>
                            <?php  if($this->session->userdata('user_role')!=19){ ?>
                         <div class="col-sm-12 col-md-3 col-lg-3">
                               <button type="button" class="btn btn-primary bgc" data-toggle="modal" data-target=".bd-compare-modal-lg">Compare</button>
                            </div><?php } ?>
                            
                            <div class="col-sm-12 col-md-3 col-lg-3">
                                <a class="btn btn info blu bgc" href="#">Chart</a>
                            </div>
  ...
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color:#ef0f0f;color:white">
        <h5 class="modal-title" id="exampleModalLabel">p</h5>
...
<!--    Compare Data -->
 ...
 <div class="modal fade bd-compare-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <div class="modal-content">
      <div class="modal-header" style="background-color:#ef0f0f;color:white">
        <h5 class="modal-title" id="exampleModalLabel">Patients dashboard</h5>
        <button type="button" class="close" style="background-color:white;" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
