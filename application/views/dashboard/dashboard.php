   ...
   <section  id="task_board">
        <div class="container">
            <div class="col-12 titl_card">
                <h3><?= !empty($heading)?$heading."Dashboard":"Dashboard" ?></h3>
            </div>
            ...
            <div class="row secnd_cls">
                ...
                <div class="col-lg-6 col-md-12">
                    <ul                    class="days_col days_col_jst">
                        ...
                        <li>
                            <input type="hidden" id="dashtype" value="<?php echo trim($heading); ?>">
                            
                                
                        <select class="form-control" id="dy" title="select <?= $heading?>">
                                ...
                                <?php
                                    ...
                                    foreach($datalist as $row)
                                    {
                                        ?>
                                                ...
                                                <option value="<?= $row->$r1 ?>"><?=  $row->$r2 ?></option>  
