	            ...
	            <div class="col-md-8 col-md-offset-2">
	                <div class="login-panel panel panel-default">
						...
						<?php $this->load->view('common/errors');?>
	                        <form role="form" method="post" action="<?php echo base_url('users/do_save_city_zone');?>" >
	                        	<div>
	                        		<h3>Add City Zone</h3>
	                        		<br>
	                        	</div>
	                           ...
	                           <option value="<?= $value->id ?>"><?= $value->country ?></option>
	                               ...
	                               <select class="form-control city" id="city_list" name="city">
	                                ...
	                                <div class="form-group">
	                                   ...
	                                   <input type="text" class="form-control" name="city_zone">
	                                    <span class="text-danger"><?= form_error('city_zone') ?></span>
	                                </div>
	                                

	                                <!-- Change this to a button or input when using this as a form -->
	                                <input type="submit" style="color:white;background-color:#ef0f0f;border-color:#ef0f0f;"  name="submit" value="Submit" class="btn  btn-success">
                            	</fieldset>
	                        </form>
	                    </div>
	                </div>
