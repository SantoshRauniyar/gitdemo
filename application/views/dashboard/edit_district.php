	            ...
	            <div class="col-md-8 col-md-offset-2">
	                <div class="login-panel panel panel-default">
						...
						<?php $this->load->view('common/errors');?>
	                        <form role="form" method="post" action="<?php echo base_url('users/do_update_district').'/'.$district->id;?>" >
	                        	<div>
	                        		<h3>Edit District</h3>
	                        		<br>
	                        	</div>
	                           ...
	                           <option value="<?= $value->id ?>"<?=$district->state_id==$value->id?"selected":"" ?> ><?= $value->state ?></option>
	                                ...
	                                <input type="submit" style="color:white;background-color:#ef0f0f;border-color:#ef0f0f;"  name="submit" value="Update District" class="btn  btn-success">
                            	</fieldset>
	                        </form>
	                    </div>
	                </div>
