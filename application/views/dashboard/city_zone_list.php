                                 	...
                                 	$('.city').change(function()
                    {
                             ...
                             //alert(cid);
                               $.ajax({
                                    ...
                                    url:'<?= base_url() ?>users/CityZoneEasyNavigation',
                                    method:'get',
                                    data:{cid:city_id,action:'<?= $view_as ?>'},

                                    success:function(pincode)
                                    {
                                        //alert(action);
                                      console.log(pincode);
                                        $('#city_zone_list').html(pincode);
                                        // $('.mycartCount').click();
...
<div style="padding:2%;">
	<div class="row">
		<div class="col-lg-12">
			<h1 class="page-header">City Zone  List</h1>
