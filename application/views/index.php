<div class="site-slider">
	<ul class="bxslider">
		<li>
			<img src="<?php echo base_url('assets/images/slider/slide1.jpg');?>" alt="slider image 1">
			<div class="container">
				<div class="row">
		...
		<li>
			<img src="<?php echo base_url('assets/images/slider/slide2.jpg');?>" alt="slider image 2">
		...
		<li>
			<img src="<?php echo base_url('assets/images/slider/slide3.jpg');?>" alt="slider image 3">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-right">
						<div class="slider-caption">
		...
		<li>
			<img src="<?php echo base_url('assets/images/slider/slide4.jpg');?>" alt="slider image 4">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-right">
						<div class="slider-caption">
		...
		<li>
			<img src="<?php echo base_url('assets/images/slider/slide5.jpg');?>" alt="slider image 5">
			<div class="container">
				<div class="row">
					<div class="col-md-12 text-right">
						<div class="slider-caption">
	...
	<div class="bx-thumbnail-wrapper">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div id="bx-pager">
						<a data-slide-index="0" href=""><img src="<?php echo base_url('assets/images/slider/thumb1.jpg');?>" alt="image 1" /></a>
						<a data-slide-index="1" href=""><img src="<?php echo base_url('assets/images/slider/thumb2.jpg');?>" alt="image 2" /></a>
						<a data-slide-index="2" href=""><img src="<?php echo base_url('assets/images/slider/thumb3.jpg');?>" alt="image 3" /></a>
						<a data-slide-index="3" href=""><img src="<?php echo base_url('assets/images/slider/thumb4.jpg');?>" alt="image 4" /></a>
						<a data-slide-index="4" href=""><img src="<?php echo base_url('assets/images/slider/thumb5.jpg');?>" alt="image 5" /></a>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2 col-sm-3">
				<div class="item-small">
					<img src="<?php echo base_url('assets/images/promotion/promotion1.jpg');?>" alt="Product 1">
					<h4>Nullam Non Ultrices Arcu</h4>
				</div> <!-- /.item-small -->
			</div> <!-- /.col-md-2 -->
			<div class="col-md-8 col-sm-6">
				<div class="item-large">
					<img src="<?php echo base_url('assets/images/promotion/promotion2.jpg');?>" alt="Product 2">
			...
			<div class="col-md-2 col-sm-3">
				<div class="item-small">
					<img src="<?php echo base_url('assets/images/promotion/promotion3.jpg');?>" alt="Product 3">
	...
	<div class="container">
		...
		<div class="row">
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						<span class="note"><img src="<?php echo base_url('assets/images/small_logo_1.png');?>" alt=""></span>
						<div class="overlay">
							<div class="overlay-inner">
								<a href="#nogo" class="view-detail">Add to Cart</a>
							</div>
						</div> <!-- /.overlay -->
						<img src="<?php echo base_url('assets/images/products/product1.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						<span class="note"><img src="<?php echo base_url('assets/images/small_logo_3.png');?>" alt=""></span>
						<div class="overlay">
							<div class="overlay-inner">
								<a href="#nogo" class="view-detail">Add to Cart</a>
							</div>
						</div> <!-- /.overlay -->
						<img src="<?php echo base_url('assets/images/products/product2.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						<span class="note"><img src="<?php echo base_url('assets/images/small_logo_2.png');?>" alt=""></span>
						<div class="overlay">
							<div class="overlay-inner">
								<a href="#nogo" class="view-detail">Add to Cart</a>
							</div>
						</div> <!-- /.overlay -->
						<img src="<?php echo base_url('assets/images/products/product3.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						...
						<img src="<?php echo base_url('assets/images/products/product4.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						...
						<img src="<?php echo base_url('assets/images/products/product5.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						...
						<img src="<?php echo base_url('assets/images/products/product6.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						...
						<img src="<?php echo base_url('assets/images/products/product7.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
			...
			<div class="col-md-3 col-sm-6">
				<div class="product-item">
					<div class="item-thumb">
						...
						<img src="<?php echo base_url('assets/images/products/product8.jpg');?>" alt="">
					</div> <!-- /.item-thumb -->
