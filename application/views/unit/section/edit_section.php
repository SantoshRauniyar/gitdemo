...
<div style="padding: 2%">
	...
	<div class="row">
		<div class="col-lg-12">
			...
			<h3 class="page-header">Edit Section</h3>
	...
	<div class="form-group">
		...
		<option value="<?=$value->pid ?>" <?= $ulist->program_id==$value->pro_name?'selected':''?>><?=$value->pro_name ?></option>
									...
									<span class="text-danger"><?=  form_error('dept') ?></span>
													...
													<input type="text" value="<?= $ulist->section_name ?>"  name="section_name" class="form-control">
									...
									<?php
											if(isset($ulist->section_head) && !empty($ulist->section_head))
											{
												echo form_dropdown('section_head',$userlist,$ulist->section_head,"  class='form-control' '");
											}
											else
											{
												echo form_dropdown('section_head',$userlist,'',"id = 'my' class='form-control head'");
											}
										?>
									<span class="text-danger"><?=  form_error('sectionhead') ?></span>
								</div>
