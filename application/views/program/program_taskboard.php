	...
	$(document).ready(function(){
                 ...
                 //check all order by OID
                               $('.program').change(function()
                    {
                            ...
                            // alert(pid);
                               ...
                               $.ajax({
                                    ...
                                    url:'<?= base_url() ?>Program/taskboardbyprogram',
                                    method:'get',
                                    data:{pid:pid},
                               ...
                               $('.end_date').mouseleave(function()
                    {
                             ...
                             // var dname=$(this).attr('dept');
                             if ((!start_date) && (!pid)) {alert("Please Select Start Date and Program ID")}
                             	else{
                           alert(pid+end_date+start_date);
                               ...
                               $.ajax({
                                    ...
                                    url:'<?= base_url() ?>program/taskboardbyprogram',
                                    method:'get',
                                    data:{pid:pid,start_date:start_date,end_date:end_date},
		...
		<div class="col-lg-12">
			<div class="panel panel-default">
				<div class="panel-heading" style="background-color: #ef0f0f;border-color:#ef0f0f;color:white;vertical-align:all;">
					<strong>Program Taskboard</strong>
					...
					?>
						...
						<div class="container">
							<div class="form-group col-md-4">
								...
								<select name="program"  id="programlist" class="program form-control">
