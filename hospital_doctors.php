...
echo $newTime;
			            ...
			            $unit=$_POST['unit_id'];
			            $hs_id=$_POST['hs_id'];
		$sql="INSERT  into taskk(hs_id,start_date,end_date,title,program,department,section,unit,assign_uid,link)values('$hs_id','$start','$newTime','$title','17','13','4','$unit','$uhead','$link')";
